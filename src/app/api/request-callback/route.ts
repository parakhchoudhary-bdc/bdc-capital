...
export async function POST(req: Request) {
  try {
    ...
    const { fullName, loanType, mobileNumber, pinCode, city, preferredCallTime } = body;
      ...
      <body>
        <div class="container">
          ...
          <div class="detail-row">
            ...
            <span>${mobileNumber || "N/A"}</span>
          </div>
          <div class="detail-row">
            <span class="label">Loan Interest:</span>
            <span>${loanType || "N/A"}</span>
          </div>
          <div class="detail-row">
            <span class="label">Pin Code:</span>
            <span>${pinCode || "N/A"}</span>
          </div>
           <div class="detail-row">
          ...
          <div class="detail-row">
            ...
            <span>${preferredCallTime || "N/A"}</span>
          </div>
          
          <div class="footer">
            <p>Sent via BDC Capital Callback Popup</p>
          </div>
        </div>
      </body>
      </html>
